...
| 13 | Portal Sync (carga de ciclo desde miUlima) | `specs/features/portal-sync/portal-sync.spec.md` | HU-SYNC-01, HU-SYNC-02 | Importación idempotente por alumno desde miUlima vía sesión de WebView; sin contraseñas en backend | `src/modules/portal-sync`, `src/config/app-config.ts` | **Diseñada — pendiente de aprobación e implementación** |
